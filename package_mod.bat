...
set "mod_name=Shards of Ice"
set mod_version=v7
set mod_folder=shardsofice
...
set mod_readme=http://htmlpreview.github.io/?https://github.com/Gibberlings3/Documentation/blob/master/readmes/readme-shardsofice.html
